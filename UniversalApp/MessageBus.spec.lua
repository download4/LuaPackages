return function()
	...
	describe("MessageBus", function()
		...
		it("should construct valid protocol method request message ids", function()
			if game:GetEngineFeature("EnableNewMessageBusServicePublishMethods") and game:GetEngineFeature("AddMessageBusService") and game:GetFastFlag("IntegrateMessageBusService") then
		...
		it("should only receive one message when once is true", function(context)
			if game:GetEngineFeature("AddMessageBusService") and game:GetFastFlag("IntegrateMessageBusService") then
				local subscriber = MessageBus.Subscriber.new()
