...
game:DefineFastInt("Roact17Rollout5", 0)
game:DefineFastFlag("Roact17RolloutEnabledForAll5", false)

-- Helper function to throttle based on a unique id:
return function()
	local rolloutEnabledForAll = game:GetFastFlag("Roact17RolloutEnabledForAll5")
	if rolloutEnabledForAll then
		return true
	end

	local rolloutPercent = game:GetFastInt("Roact17Rollout5")
