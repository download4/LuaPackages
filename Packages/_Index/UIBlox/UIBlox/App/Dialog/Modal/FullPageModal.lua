...
FullPageModal.validateProps = t.strictInterface({
	...
	marginSize = t.optional(t.number), -- Requires UIBloxConfig.modalMarginSize to work correctly
	...
	return Roact.createElement(ModalWindow, {
		...
		Content = Roact.createElement("Frame", {
			...
			Roact.createElement("UIPadding", {
				PaddingLeft = UDim.new(0, UIBloxConfig.modalMarginSize and 0 or MARGIN),
				PaddingRight = UDim.new(0, UIBloxConfig.modalMarginSize and 0 or MARGIN),
				PaddingBottom = UDim.new(0, MARGIN),
			}),
			MiddleContent = Roact.createElement("Frame", {
				Size = UDim2.new(1,
					UIBloxConfig.modalMarginSize and -2 * self.props.marginSize or 0,
					1, -self.state.buttonFrameSize.Y),
				BackgroundTransparency = 1,
				LayoutOrder = 1
