...
local RelevancyInfo = require(App.Indicator.RelevancyInfo)
...
local function footer(props)
	return withStyle(function(style)
		return Roact.createElement("Frame", {
			...
			RelevancyInfo = Roact.createElement(RelevancyInfo, props.relevancyInfo),
		})
	end)
end
	...
	return withStyle(function(style)
		return Roact.createElement("Frame", {
			...
			Tile = Roact.createElement(Tile, {
				footer = footer({
					relevancyInfo = self.props.relevancyInfo,
